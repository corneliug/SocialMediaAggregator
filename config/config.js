module.exports = {
  ...
  apps: {
    ...
    instagram: {key: "1da7d5643ac64630b99eba92610c7583", secret: "ca04749b72d047dfa8e03bca7df98ec9", redirectUri: "http://localhost:8080/instagram/authcallback"},  // to be updated
    google: {key: "AIzaSyA7qCOvn3YgjDqeBuNvOLYqnceVfzfCND0"}  // to be updated
  },
  accounts: {
    twitter: ["@cristiano", "@facebook", "#govtech"],
    facebook: ["@cristiano", "@facebook"],
